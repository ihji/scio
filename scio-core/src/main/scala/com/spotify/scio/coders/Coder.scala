...
import org.apache.beam.sdk.coders.{AtomicCoder, StringUtf8Coder, Coder => BCoder}
...
object Coder extends CoderGrammar with Implicits {
  ...
  implicit def jBigIntegerCoder: Coder[JBigInteger] = Coder.beam(BigIntegerCoder.of())

  implicit def jBigDecimalCoder: Coder[JBigDecimal] = Coder.beam(BigDecimalCoder.of())
